import { E as resolveComponent, c as createElementBlock, F as Fragment, G as renderList, p as unref, m as createBaseVNode, a as createTextVNode, o as openBlock, b as createBlock } from "./chunks/framework.Cac4KkLP.js";
const NAV_DATA = [
  {
    title: "常用工具",
    items: [
...
const _hoisted_1 = /* @__PURE__ */ createBaseVNode("h1", {
  ...
  /* @__PURE__ */ createTextVNode("前端导航 "),
  /* @__PURE__ */ createBaseVNode("a", {
    class: "header-anchor",
    href: "#前端导航",
    "aria-label": 'Permalink to "前端导航"'
  }, "​")
], -1);
const _hoisted_2 = /* @__PURE__ */ createBaseVNode("br", null, null, -1);
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("div", { class: "tip custom-block" }, [
  /* @__PURE__ */ createBaseVNode("p", { class: "custom-block-title" }, "TIP"),
  /* @__PURE__ */ createBaseVNode("p", null, [
    /* @__PURE__ */ createTextVNode("该导航由 "),
    /* @__PURE__ */ createBaseVNode("a", {
      href: "https://github.com/maomao1996",
      target: "_blank",
      rel: "noreferrer"
    }, "maomao"),
    /* @__PURE__ */ createTextVNode(" 开发，如有引用、借鉴的请保留版权声明："),
    /* @__PURE__ */ createBaseVNode("a", {
      href: "https://github.com/maomao1996/vitepress-nav-template",
      target: "_blank",
      rel: "noreferrer"
    }, "https://github.com/maomao1996/vitepress-nav-template")
  ])
], -1);
const __pageData = JSON.parse('{"title":"前端导航","description":"","frontmatter":{"layoutClass":"m-nav-layout","outline":[2,3,4]},"headers":[],"relativePath":"nav/index.md","filePath":"nav/index.md","lastUpdated":1743432071000}');
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", null, [
        _hoisted_1,
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(NAV_DATA), ({ title, items }) => {
          return openBlock(), createBlock(_component_MNavLinks, {
            title,
            items
          }, null, 8, ["title", "items"]);
        }), 256)),
